...
public final class ImmutableBugReport extends BugReport {
  ...
  private boolean equalTo(ImmutableBugReport another) {
    return nameNonNull.equals(another.nameNonNull)
        ...
        && emailsEclipseNullable.equals(another.emailsEclipseNullable);
  }
  ...
  public int hashCode() {
    ...
    h += (h << 5) + emailsEclipseNullable.hashCode();
    return h;
  }
   ...
   *    .addEmailsEclipseNullable|addAllEmailsEclipseNullable(String) // {@link BugReport#emailsEclipseNullable() emailsEclipseNullable} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private List<String> emailsEclipseNullable = new ArrayList<String>();
    ...
    public final Builder from(BugReport instance) {
      ...
      addAllEmailsEclipseNullable(instance.emailsEclipseNullable());
      return this;
    }
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder addEmailsEclipseNullable(String element) {
      this.emailsEclipseNullable.add(Objects.requireNonNull(element, "emailsEclipseNullable element"));
      return this;
    }
    ...
    public final Builder emailsEclipseNullable(Iterable<String> elements) {
      this.emailsEclipseNullable.clear();
    ...
    public ImmutableBugReport build() {
      ...
      return new ImmutableBugReport(
          ...
          createUnmodifiableList(true, emailsEclipseNullable));
    }
